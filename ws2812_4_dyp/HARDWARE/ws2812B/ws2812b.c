...
#define LIGHT_LED_NUM_H		4
#define LED_LENTH_H       4

#define LIGHT_LED_NUM		4
#define LED_LENTH       4
...
//		r[2] = 222;     g[2] = 68;     b[2] = 248;   w[2] = 0;
		r[0] = 248;     g[0] = 0;      b[0] = 255;   w[0] = 0;
	 r[1] = 216;     g[1] = 71;     b[1] = 247;   w[1] = 0;
	 r[2] = 152;   g[2] = 85;     b[2] = 231;   w[2] = 0;		//紫
	 r[3] = 72;     g[3] = 60;     b[3] = 215;   w[3] = 0;
...
//	 r[2] = 0;   g[3] = 255; b[3] = 255;   w[3] = 0;
//	 r[3] = 128; g[5] = 0;   b[5] = 255;   w[5] = 0;		//紫
//	
//	 if(color_running_tick>=10)
//	 {
//		 color_running_tick=0;
//		 
//		 r0=r[3];g0=g[3];b0=b[3];w0=w[3];
//		 
//		 for(i=0;i<3;i++)
//		 {
//			 r[i+1]=r[i];
