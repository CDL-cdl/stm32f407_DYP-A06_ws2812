...
void running_water_orange(){
	led_fly(1,ORGANGE_FLY);
	led_fly_H(1,ORGANGE_FLY);
}

void running_water_red(){
	led_fly(1,RED_FLY);
	led_fly_H(1,RED_FLY);
}
...
//	u8 sum1,sum2,sum3,sum4;
	f[0] = running_water_red;
	f[1] = breating_blue_5;
	f[2] = Rainbowcolor;
	f[3] = breating_blue_5;
	f[4] = breating_blue_3;
	f[5] = breating_orange_1;
