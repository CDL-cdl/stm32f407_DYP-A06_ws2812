...
void TIM3_Int_Init(u16 arr,u16 psc)
{
  ...
  TIM_TimeBaseInit(TIM3,&TIM_TimeBaseInitStructure);// ②初始化定时器 TIM2
  TIM_ITConfig(TIM3,TIM_IT_Update,ENABLE); //③允许定时器 2 更新中断

  NVIC_InitStructure.NVIC_IRQChannel=TIM3_IRQn; //定时器 2 中断
